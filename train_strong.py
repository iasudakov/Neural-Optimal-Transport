...
wandb.init(name='strong_NOT', project='diffusion-NOT')
...
for step in tqdm(range(MAX_STEPS)):
    ...
    if step % CPKT_INTERVAL == 0:
        ...
        torch.save(T.state_dict(), f'/home/sudakovcom/Desktop/diffusion/NOT/checkpoints/T_{step}.pt')
        torch.save(f.state_dict(), f'/home/sudakovcom/Desktop/diffusion/NOT/checkpoints/f_{step}.pt')
        torch.save(f_opt.state_dict(), f'/home/sudakovcom/Desktop/diffusion/NOT/checkpoints/f_opt_{step}.pt')
        torch.save(T_opt.state_dict(), f'/home/sudakovcom/Desktop/diffusion/NOT/checkpoints/T_opt_{step}.pt')
